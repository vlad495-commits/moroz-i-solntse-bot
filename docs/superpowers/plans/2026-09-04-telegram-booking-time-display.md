...
- [x] **Step 1: Write the failing formatter and message tests**
...
- [x] **Step 1: Write failing planner and repository tests**
...
- [x] **Step 3: Implement the minimal planner flag**
...
- [x] **Step 4: Run GREEN and focused regression in Docker**
...
- [x] **Step 1: Re-read shared files and preserve concurrent additions**

Read the current tails of `Дорожная карта.md` and `changelog.md`; append only this task's result.

- [x] **Step 2: Run final Docker and static gates**
...
- [x] **Step 4: Commit only shared documentation after checking concurrent state**

...
- [ ] **Step 1: Создать постоянный контракт**
...
- [ ] **Step 2: Сделать контракт обязательным в дорожной карте**
...
- [ ] **Step 3: Зарегистрировать владельца правила**
...
- [ ] **Step 4: Записать действие в changelog**
...
- [ ] **Step 5: Проверить документальные контракты**
...
- [ ] **Step 6: Сделать локальный commit**

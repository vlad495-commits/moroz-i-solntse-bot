...
**Tech Stack:** Git bundle, Docker Compose `moroz-staging`, Docker image IDs/tags/archive, Alembic, existing staging webhook/smoke/log scanner, password-based Docker/`expect` SSH wrapper.
...
- [ ] **Step 1: Verify local identity and source scope**
...
- [ ] **Step 1: Run fresh full Docker gate**
...
- [ ] **Step 1: Self-review requirements line by line**
...
- [ ] **Step 4: Close documents and commit**

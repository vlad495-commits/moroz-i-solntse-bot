...
docker compose --env-file ../.env --project-name moroz_lifecycle_0008 run --rm migrate
docker compose --env-file ../.env --project-name moroz_lifecycle_0008 run --rm migrate alembic -c /app/alembic.ini current
docker compose --env-file ../.env --project-name moroz_lifecycle_0008 build worker scheduler
docker compose --env-file ../.env --project-name moroz_lifecycle_0008 run --rm --no-deps worker python -m compileall -q /app
docker compose --env-file ../.env --project-name moroz_lifecycle_0008 run --rm --no-deps scheduler python -m compileall -q /app
```

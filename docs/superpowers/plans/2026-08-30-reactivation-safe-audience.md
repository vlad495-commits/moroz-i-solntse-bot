...
**Files:**
- Create: `project/migrations/versions/0023_reactivation_draft.py`
...
- [x] Run RED in Docker.
- [x] Add migration `0023` after integrated head `0022_admin_statistics` that replaces the delivery status check with `('draft','queued','skipped','sent','error')`.

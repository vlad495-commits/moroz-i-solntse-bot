...
Обновить `docs/architecture/moroz-i-solntse-full-architecture.html`, чтобы один автономный файл одновременно показывал фактический staging-контур и согласованную целевую архитектуру продукта.

...
Миграция additive от фактической Alembic head. В изолированной ветке ожидаемым номером был `0023`; при интеграции с уже развёрнутым `0023_reactivation_draft` окончательная линейная head — `0024_reactivation_v2`.

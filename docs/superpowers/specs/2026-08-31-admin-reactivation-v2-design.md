...
**Статус:** подготовлено для ревью владельцем 2026-08-31  
...
## 12. Новая вкладка «Реактивация»

Вкладка остаётся owner-only и состоит из шести блоков.

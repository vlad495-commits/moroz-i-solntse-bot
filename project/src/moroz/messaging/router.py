...
Если клиент не знает название услуги и просит подобрать вариант по цели, выбери consultation/none,
даже если в том же сообщении он спрашивает цену. Не требуй сначала назвать услугу.

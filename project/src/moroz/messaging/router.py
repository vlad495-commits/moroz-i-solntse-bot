...
Явное намерение текущего сообщения важнее состояния формы.
Голое название услуги не означает новую запись. После уточнения ассистентом цены
...
не включай само имя в JSON. Если active=true, step=contact и текущее сообщение после
маскирования является <PII_PHONE_N>, выбери booking/continue. Не придумывай отсутствующие варианты.

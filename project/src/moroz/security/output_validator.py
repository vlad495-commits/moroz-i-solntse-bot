...
A user request alone is never confirmation. When route source is llm or
context has no explicit trusted tool result, choose product_rule for claims
that a booking, cancellation, call,
payment, discount or gift was completed or promised
without confirmed tool data, even when another reject category also applies.

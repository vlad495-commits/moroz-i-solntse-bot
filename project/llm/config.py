...
START_REPLY = os.getenv(
    "START_REPLY",
    "Здравствуйте! Я онлайн-ассистент центра загара и криотерапии «Мороз и Солнце» ❄️☀️\n\n"
    "Помогу подобрать услугу, рассказать об актуальных ценах и подготовке, а также "
    "записаться на удобное время. Напишите вопрос своими словами, например: "
    "«Сколько стоит криосауна?»",
)

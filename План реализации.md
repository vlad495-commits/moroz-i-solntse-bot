...
| 3 | [YCLIENTS Booking](docs/superpowers/plans/2026-07-14-production-v1-yclients-booking.md) | Создание, перенос, отмена, конфликт и fallback через mock/real adapter | 1–2 |
| 4 | [LLM Security](docs/superpowers/plans/2026-07-14-production-v1-llm-security.md) | Маскирование, guardrails, primary/reserve, router, validator, evals | 1–2 |
| 5 | [Scheduler & Notifications](docs/superpowers/plans/2026-07-14-production-v1-notifications.md) | Напоминания, no-show, feedback once, эскалации | 1–4 |
| 6 | [Production Admin](docs/superpowers/plans/2026-07-14-production-v1-admin.md) | Роли, TOTP, диалоги, записи, знания, health и аудит | 1–5 |
| 7 | [Operations & Release](docs/superpowers/plans/2026-07-14-production-v1-operations.md) | TLS, алерты, backup/restore, load/failure tests, launch checklist | 1–6 |
...
- [ ] Фаза 2 — Reliable Telegram Pipeline: Tasks 1–4 и implementation checkpoint выполнены; whole-branch fix-loop устранил замечания по webhook secret, per-chat delivery order, Redis-loss startup/recovery, Telegram error classification и bounded shutdown. Фаза остаётся открытой до повторного независимого review; live Telegram E2E вынесен в следующий staging checkpoint (отдельный test token, HTTPS ingress, `setWebhook`).
- [ ] Фазы 3–7 — ожидают своих зависимостей.

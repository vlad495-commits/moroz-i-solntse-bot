...
[2026-07-04 00:27] На странице «Диалоги» карточки и таблица переложены в dashboard-композицию по референсу: блок метрик слева, LLM-модели справа сверху, таблица диалогов справа снизу; данные не менялись.
